...
console.log(players1[0], players2[0]);

console.log("************************");
console.log("************************");

// Task2
// erster Goalkeeper Rest soll in die Arrays kan man die REST Syntax verwenden
...
*/
// Mit dem Rest Paramater
const printGoals = function (...playerssss) {
  console.log(`${playerssss.length} Goals where scored`);
};

printGoals("Davies", "Muller", "Lewandowski", "Kimmich", "Alaba");
printGoals("Kimmich", "Alaba");
console.log("************************");
console.log("************************");
